...
import { Heart, Brain, BookOpen, Headphones, MessageCircle, Library, ArrowRight, Sparkles } from 'lucide-react'
      ...
      >
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
          <div className="space-y-2">
            <div className="text-3xl font-bold text-pastel-purple">10K+</div>
            <div className="text-gray-600">Active Users</div>
          </div>
          <div className="space-y-2">
            <div className="text-3xl font-bold text-pastel-blue">95%</div>
            <div className="text-gray-600">Satisfaction Rate</div>
          </div>
          <div className="space-y-2">
            <div className="text-3xl font-bold text-pastel-green">24/7</div>
